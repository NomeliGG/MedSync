...
* [Spring Data for Apache Cassandra](https://docs.spring.io/spring-boot/4.0.0-SNAPSHOT/reference/data/nosql.html#data.nosql.cassandra)
* [Spring for Apache Kafka](https://docs.spring.io/spring-boot/4.0.0-SNAPSHOT/reference/messaging/kafka.html)
